  ...
  const recommendedHotels = [
    {
      ...
      priceMax: 500,
      discount: '10% OFF',
      imageUrl: 'https://www.figma.com/api/mcp/asset/23b4a9be-c4cd-40ec-9c30-1ee1d0480a47',
    },
    {
      id: '2',
      name: 'COMO Uma Re',
      ...
      priceMax: 500,
      discount: '10% OFF',
      imageUrl: 'https://www.figma.com/api/mcp/asset/1f32878d-8da3-4c92-86ae-d886f610c658',
    },
  ];
  ...
  const businessAccommodates = [
    {
      ...
      imageUrl: 'https://www.figma.com/api/mcp/asset/0ef0a288-6de3-4718-9a70-dac9cfef6a55',
      amenities: ['Fast Wi-Fi', 'AC Conference rooms'],
    },
    {
      id: '2',
      name: 'Work Station',
      imageUrl: 'https://www.figma.com/api/mcp/asset/b15f6f84-ad82-429a-a97f-56b443d1a64c',
